(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.VtWindow = factory());
  ...
  class Drag {
      ...
      constructor(targetElm, handleElm, options) {
        ...
        const moveOp = (x, y) => {
          ...
          let t = y - offTop;
          if (y - offTop <= 30) t = 30; // limit to 30px from the top
          ...
          // NOTE: profiling on chrome translate wasn't faster than top/left as expected. And it also permanently creates a new layer, increasing vram usage.
